...
class Quiz {
    ...
    nextQuestion() {
        ...
        if (checkedElement.length === 0) alert('Tu dois sélectionner une réponse');
        else {
    ...
    showResult() {
        this.questions[this.answeredAmount].isCorrect ? alert('Bonne réponse') : alert('Mauvaise réponse');
    }
